...
import { updateDepartment, fetchDepartments } from '../../lib/slices/departmentSlice';
...
export default function EditDepartmentModal() {
  ...
  const isOpen = useAppSelector((state) => state.ui.modals.editDepartment);
  ...
  useEffect(() => {
    if (selectedDepartment && isOpen) {
      reset({
        ...
        colorCode: selectedDepartment.colorCode || '',
        manager: selectedDepartment.manager?._id || '',
      });
    }
  }, [selectedDepartment, isOpen, reset]);
  ...
  const onSubmit = async (data: DepartmentFormData) => {
    ...
    try {
      ...
      dispatch(closeModal('editDepartment'));
