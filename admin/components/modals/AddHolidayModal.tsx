...
import { createHoliday, fetchHolidays } from '../../lib/slices/holidaySlice';
...
export default function AddHolidayModal() {
  ...
  const isOpen = useAppSelector((state) => state.ui.modals.addHoliday);
  ...
  const onSubmit = async (data: HolidayFormData) => {
    try {
      ...
      dispatch(closeModal('addHoliday' as any));
      reset();
